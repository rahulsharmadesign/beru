...
enum EnhancifyMetrics {
    ...
    /// `EnhancifyRadius.sm` so the well is a rounded square, not a circle.
    ...
    static let workspaceChromeMinHeight = EnhancifySpace.xxl

    static let contentPadding = EnhancifySpace.xl
    static let headerContentSpacing = EnhancifySpace.md
    ...
    static var helpPillOffset: CGFloat { metapillHeight + EnhancifySpace.xs }
